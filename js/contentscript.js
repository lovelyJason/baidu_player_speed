...
function showModal(text) {
  var message = `<div role="alert" class="el-message el-message--success" style="top: 230px; z-index: 2023;"><i class="el-message__icon el-icon-success"></i><p class="el-message__content">${text}</p><!----></div>`
...
function copy(link) {
  ...
  showModal('成功复制链接，可以直接下载或使用工具下载')
}
  ...
  injectCustomJs(null, function () {
    var btns = `<div class="baidu_player_speed style="margin-top: 2px;">
      <div class="layui-form-item" style="width: 1000px;">
        ...
        <div class="layui-inline">
          <label class="layui-form-label" style="width: 100px">自定义倍速</label>
          <div class="layui-input-block">
            <div class="layui-unselect layui-form-select">
              ...
              <dl class="layui-anim layui-anim-upbit" style="">
                ...
                <dd lay-value="1.5" class="">1.5</dd>
                <dd lay-value="1.6" class="">1.6</dd>
                <dd lay-value="1.7" class="">1.7</dd>
                <dd lay-value="1.8" class="">1.8</dd>
                <dd lay-value="1.9" class="">1.9</dd>
                <dd lay-value="2.0" class="">2.0</dd>
                <dd lay-value="2.5" class="">2.5</dd>
                <dd lay-value="2.6" class="">2.6</dd>
                <dd lay-value="2.7" class="">2.7</dd>
                <dd lay-value="2.8" class="">2.8</dd>
                <dd lay-value="2.9" class="">2.9</dd>
                <dd lay-value="3.0" class="">3.0</dd>
